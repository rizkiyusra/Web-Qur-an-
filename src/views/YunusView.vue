...
export default {
  ...
  methods: {
    async getChapter() {
      fetch("https://api.quran.com/api/v4/chapters/10?language=id", {
        method: "GET",
      })
        .then((response) => {
          if (response.ok) {
    ...
    async getVerse() {
      fetch(
        "https://api.quran.com/api/v4/quran/verses/uthmani?chapter_number=10",
        {
          method: "GET",
        }
      )
    ...
    async getChapterInfo() {
      fetch("https://api.quran.com/api/v4/chapters/10/info?language=id", {
        method: "GET",
      })
        .then((response) => {
          if (response.ok) {
    ...
    async getAudio_File() {
      fetch("https://api.quran.com/api/v4/chapter_recitations/7/10", {
        method: "GET",
      })
        .then((response) => {
          if (response.ok) {
    ...
    async getTranslation() {
      fetch(
        "https://api.quran.com/api/v4/quran/translations/33?fields=id&chapter_number=10",
        {
          method: "GET",
        }
      )
